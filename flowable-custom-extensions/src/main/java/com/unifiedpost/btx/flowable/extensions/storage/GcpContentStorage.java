...
public class GcpContentStorage extends AbstractContentStorage implements ContentStorage {
	...
	@Override
	public ContentObject updateContentObject(
			String contentId, InputStream contentStream, ContentObjectStorageMetadata metaData) {
	...
	protected ContentObject uploadFile(
			InputStream contentStream, String contentId, ContentObjectStorageMetadata metadata) {
	...
	private String inspectMetaData(ContentObjectStorageMetadata metaData) {
		...
		output.append("Metadata type = ")
				.append(metaData.getClass().getName())
				.append("\n")
				.append("Metadata type = ")
				.append(metaData.getClass().getTypeName())
				.append("\n")
				.append("Metadata type = ")
				.append(metaData.getClass().getCanonicalName())
				.append("\n")
				.append("Metadata content name = ")
				.append(metaData.getName())
				.append("\n")
				.append("Metadata content scope id = ")
				.append(metaData.getScopeId())
				.append("\n")
				.append("Metadata content scope type = ")
				.append(metaData.getScopeType())
				.append("\n")
				.append("Metadata content mime type = ")
				.append(metaData.getMimeType())
				.append("\n")
				.append("Metadata content tenant id = ")
				.append(metaData.getTenantId())
				.append("\n");
		if (metaData instanceof ContentItemContentObjectStorageMetadata) {
			ContentItem contentItem =
					(ContentItem) ((ContentItemContentObjectStorageMetadata) metaData).getStoredObject();
			output.append("Content Item id = ")
					.append(contentItem.getId())
					.append("\n")
					.append("Content Item name = ")
					.append(contentItem.getName())
					.append("\n")
					.append("Content Item mimeType = ")
					.append(contentItem.getMimeType())
					.append("\n")
					.append("Content Item task id = ")
					.append(contentItem.getTaskId())
					.append("\n")
					.append("Content Item process instance id = ")
					.append(contentItem.getProcessInstanceId())
					.append("\n")
					.append("Content Item scope id = ")
					.append(contentItem.getScopeId())
					.append("\n")
					.append("Content Item content store id = ")
					.append(contentItem.getContentStoreId())
					.append("\n")
					.append("Content Item content store name = ")
					.append(contentItem.getContentStoreName())
					.append("\n")
					.append("Content Item - is content available = ")
					.append(contentItem.isContentAvailable())
					.append("\n")
					.append("Content Item - is provisional = ")
					.append(contentItem.isProvisional())
					.append("\n")
					.append("Content Item content size = ")
					.append(contentItem.getContentSize())
					.append("\n")
					.append("Content Item creation date = ")
					.append(contentItem.getCreated())
					.append("\n")
					.append("Content Item creator = ")
					.append(contentItem.getCreatedBy())
					.append("\n")
					.append("Content Item last modification date = ")
					.append(contentItem.getLastModified())
					.append("\n")
					.append("Content Item last modified by = ")
					.append(contentItem.getLastModifiedBy())
					.append("\n");
		}
