...
public class SecurityConfiguration {
	...
	public SecurityFilterChain basicDefaultSecurity(
		...
		if (frontendProperties != null
				&& frontendProperties.getFeatures().containsKey("formBasedLogout")
		...
		http
				...
				// We have to initialize the exception handling with a default authentication entry point in order to
				// return 401 each time and not have a
				...
				.and()
				.authorizeRequests()
				.antMatchers("/analytics-api/**")
				.hasAuthority(SecurityConstants.ACCESS_REPORTS_METRICS)
				.antMatchers("/work-object-api/**")
				.hasAuthority(SecurityConstants.ACCESS_WORKOBJECT_API)
